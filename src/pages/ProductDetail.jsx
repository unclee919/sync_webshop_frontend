    ...
    <div className={`products-page container ${isRtl ? 'rtl' : 'ltr'}`}>
      ...
      <div className="product-detail-layout">
        ...
        <div className="product-info">
          ...
          <div className="detail-price">{item.price != null ? <span className="current-price">{formatStorefrontPrice(item.price, undefined, c)}</span> : <span className="price-empty">{isArabic ? 'السعر عند الطلب' : 'Price on request'}</span>}</div>
